            ...
            <div className="min-h-screen bg-background">
                <div className="flex flex-col lg:flex-row min-h-screen">
                    ...
                    <div className="lg:w-[370px] bg-gradient-to-b from-primary/30 via-accent/25 to-primary/20 flex flex-col items-center justify-center p-8 lg:p-12 relative backdrop-blur-sm">
                        {/* Back Button (optional, can be hidden) */}
                        <div className="absolute top-6 left-6 w-12 h-12 bg-foreground/10 rounded-2xl flex items-center justify-center lg:hidden backdrop-blur-sm">
                            <span className="text-2xl text-foreground">←</span>
                        </div>

                        {/* Large Profile Image */}
                        <div className="w-56 h-56 rounded-full bg-card/90 flex items-center justify-center mb-8 shadow-xl ring-4 ring-primary/30">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12 mb-12">
                                {teamMembers.slice(0, 3).map((member, index) => (
                                    <div key={index} className="flex flex-col items-center text-center group">
                                        {/* Profile Image */}
                                        <div className="w-32 h-32 rounded-full border-4 border-primary/40 bg-card/80 flex items-center justify-center mb-4 shadow-lg group-hover:border-primary group-hover:shadow-primary/20 transition-all duration-300">
